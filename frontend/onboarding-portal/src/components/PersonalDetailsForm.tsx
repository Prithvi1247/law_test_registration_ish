...
interface PersonalDetailsFormProps {
  onContinue: (applicantId: number) => void;
}

export function PersonalDetailsForm({ onContinue }: PersonalDetailsFormProps) {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    // Applicant already created for this session — Continue should just
    // move forward without creating a duplicate applicant.
    if (applicantId !== null) {
      onContinue(applicantId);
      return;
    }
    ...
    if (userId === null) {
      setSubmitError("No active user session was found. Please sign in again.");
      return;
    }
